...
start_sonar:
	/mnt/work/sonar/sonarqube-6.7.2/bin/linux-x86-64/sonar.sh start
stop_sonar:
	/mnt/work/sonar/sonarqube-6.7.2/bin/linux-x86-64/sonar.sh stop
run_sonar:
	/mnt/work/sonar/sonar-runner-2.4/bin/sonar-runner